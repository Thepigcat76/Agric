...
public class DryingRackMenu extends AbstractContainerMenu {
    ...
    public DryingRackMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public DryingRackMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.DRYING_RACK_MENU.get(), id);
        checkContainerSize(inv, 3);
        blockEntity = (DryingRackEntity) entity;
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 116, 36));
        });
