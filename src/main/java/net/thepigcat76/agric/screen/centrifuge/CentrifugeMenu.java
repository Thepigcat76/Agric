...
public class CentrifugeMenu extends AbstractContainerMenu {
    public final CentrifugeEntity blockEntity;
    ...
    public CentrifugeMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        blockEntity = (CentrifugeEntity) entity;
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 88, 36));
            this.addSlot(new SlotItemHandler(handler, 2, 122, 36));
            this.addSlot(new SlotItemHandler(handler, 3, 166, 36));
            this.addSlot(new SlotItemHandler(handler, 4, 210, 36));
        });
